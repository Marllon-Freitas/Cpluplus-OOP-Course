/*
Considerando	o	registro	Jogo	definido	abaixo,	implemente	o	código	para	as	funções
e	construa	um	programa	para	testar	a	criação	de	uma	variável	do	tipo	Jogo.	Teste
também	a	utilização	das	funções.
